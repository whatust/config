...
" Syntax for git diff
call <sid>hi('DiffAdded'               , s:bright_green   , ''              , ''          , '')
call <sid>hi('DiffRemoved'             , s:bright_red     , ''              , ''          , '')
call <sid>hi('DiffFile'                , s:bright_yellow  , ''              , ''          , '')
call <sid>hi('DiffNewFile'             , s:bright_yellow  , ''              , ''          , '')
call <sid>hi('DiffChange'              , ''               , ''              , ''          , '')
call <sid>hi('DiffIndexLine'           , s:yellow         , ''              , ''          , '')
call <sid>hi('DiffLine'                , s:bright_magenta , ''              , ''          , '')
call <sid>hi('diffSubname'             , s:bright_magenta , ''              , ''          , '')

call <sid>hi('DiffDelete'              , s:bright_red     , ''              , ''          , '')
call <sid>hi('DiffText'                , s:bright_blue    , ''              , ''          , '')
call <sid>hi('DiffAdded'               , s:bright_green   , ''              , ''          , '')

" Syntax for gigutter
call <sid>hi('GitGutterAdd'            , s:bright_green   , s:none          , s:bold      , '')
call <sid>hi('GitGutterChange'         , s:bright_magenta , s:none          , s:bold      , '')
...
" Syntax for gigutter
call <sid>hi('gitmessengerPopupNormal' , s:bright_white   , ''       , ''          , '')
call <sid>hi('gitmessengerHeader'      , s:bright_cyan    , ''       , ''          , '')
call <sid>hi('gitmessengerHash'        , s:yellow         , ''       , ''          , '')
call <sid>hi('gitmessengerHistory'     , s:bright_magenta , ''       , ''          , '')
